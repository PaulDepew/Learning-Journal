# Important features for a text editor: 
-Code Completion
-Syntax highlighting
...
Test editor edits text, IDE (Integrated Development Environment) is the full package (text editor, file manager, compiler, and debugger)
